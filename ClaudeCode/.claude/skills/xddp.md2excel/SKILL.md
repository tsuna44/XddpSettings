...
`~/.claude/skills/xddp.md2excel/scripts/crs_md2excel.py` handles all of: Markdown parsing, Excel generation, and change history sheet output.
...
If `~/.claude/skills/xddp.md2excel/scripts/crs_md2excel.py` is not found, tell the user to run `setup.sh`.
