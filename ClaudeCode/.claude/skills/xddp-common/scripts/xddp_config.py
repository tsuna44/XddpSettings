...
KEY_DOCS = [
    ...
    {"key": "SPECOUT_CROSS_PROPAGATE", "default": "true", "consumer": "xddp-04-specout（Step A-cross-propagate。クロスリポジトリ共有シンボルの消費リポジトリへの1ラウンド追加探索）"},
    ...
    {"key": "VCS_TYPE", "default": "auto", "consumer": "xddp-07-code/xddp-08-verify/xddp-10-test-run/xddp-close の VCS 操作"},
