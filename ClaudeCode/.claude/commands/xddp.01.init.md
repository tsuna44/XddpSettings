...
5. Copy `~/.claude/skills/xddp.templates/xddp.config.md` to `./xddp.config.md` if not already present.
...
6. Copy per-repo and shared steering files:
   - `~/.claude/skills/xddp.templates/project-steering-template.md` → `{XDDP_DIR}/project-steering.md` (shared, if absent)
...
See `.claude/skills/xddp.01.init/SKILL.md` for full orchestration logic.
