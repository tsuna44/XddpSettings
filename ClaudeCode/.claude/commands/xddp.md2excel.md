...
1. Run `~/.claude/skills/xddp.md2excel/scripts/crs_md2excel.py` via Bash to generate Excel from CRS Markdown.
2. Save to `{CR}/03_change-requirements/CRS-{CR}.xlsx`.
3. Report UR/SR/SP counts and output path in Japanese.

See `.claude/skills/xddp.md2excel/SKILL.md` for full orchestration logic.
