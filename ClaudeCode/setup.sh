...
OLD_XDDP_DIRS=(
  ...
  # 2026-09-21: ドット区切り→ハイフン区切りへの一括リネーム（ADR-0017）
  "skills/xddp.01.init"
  "skills/xddp.02.analysis"
  "skills/xddp.03.req"
  "skills/xddp.04.specout"
  "skills/xddp.05.arch"
  "skills/xddp.06.design"
  "skills/xddp.07.code"
  "skills/xddp.08.verify"
  "skills/xddp.09.test"
  "skills/xddp.10.test-run"
  "skills/xddp.11.specs"
  "skills/xddp.abort"
  "skills/xddp.close"
  "skills/xddp.codemap"
  "skills/xddp.common"
  "skills/xddp.crs-view"
  "skills/xddp.excel2md"
  "skills/xddp.feedback"
  "skills/xddp.fill-rulebook"
  "skills/xddp.md2excel"
  "skills/xddp.plan-review"
  "skills/xddp.review"
  "skills/xddp.revise"
  "skills/xddp.set-profile"
  "skills/xddp.status"
  "skills/xddp.survey"
  "skills/xddp.sync-design"
  "skills/xddp.update-knowledge"
  "skills/xddp.rules"
  "skills/xddp.templates"
)
