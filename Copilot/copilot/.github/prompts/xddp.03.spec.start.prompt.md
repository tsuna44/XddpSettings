---
mode: agent
description: "XDDP フェーズ2: 変更対象の識別子を起点にスペックアウト（母体調査）を開始する"
---
...
**成果物の生成に専念してください。レビューは `#xddp.04.spec.review` が担当します。**
...
ファイルが存在しない場合は `#xddp.01.req.start` を先に実行するよう案内してください。
