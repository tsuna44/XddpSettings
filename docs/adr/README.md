...
| [ADR-0017](ADR-0017-skill-dir-hyphen-naming.md) | スキルディレクトリ名をドット区切りからハイフン区切りへ統一する理由 | ClaudeCode/.claude/skills/**（全ディレクトリ）, ClaudeCode/setup.sh, tools/harness/refcheck.py |
